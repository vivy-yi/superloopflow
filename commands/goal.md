...
/superloopflow:goal create-goals --brief "ship the migration" --goal "Schema::Add columns" --goal "Backfill::Backfill rows" --goal "Cutover::Switch reads"
/superloopflow:goal complete-goals
/superloopflow:goal status
/superloopflow:goal checkpoint --goal-id G001-... --status complete --evidence "tests passed"
/superloopflow:goal record-review-blockers --goal-id G00X-... --title "Fix review findings" --evidence "<review findings>"
```
